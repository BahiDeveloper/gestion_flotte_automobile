                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="date_naissance" class="form-label">Date de naissance <span
                                                    class="text-danger">*</span></label>
                                            <input type="date" name="date_naissance" id="date_naissance" max="<?= date('Y-m-d') ?>"
                                                class="form-control"
                                                value="<?= isset($form_data['date_naissance']) ? $form_data['date_naissance'] : '' ?>"
                                                required>
                                            <div class="invalid-feedback">La date doit être valide et le chauffeur doit
                                                avoir au moins 18 ans</div>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="date_embauche" id="date_embauche"
                                                ...
                                                value="<?= isset($form_data['date_embauche']) ? $form_data['date_embauche'] : '' ?>"
                                                required>
                                            <div class="invalid-feedback">La date d'embauche ne peut pas être dans le
                                                futur</div>
                                        </div>
                                        <div class="mb-3">
