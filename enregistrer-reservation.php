...
try {
    ...
    $sql = "INSERT INTO reservations_vehicules (
        ...
        nombre_passagers, id_vehicule, statut, objet_demande, zone_vehicule_id
    ) VALUES (
        :id_utilisateur, :demandeur, NOW(), :date_depart, :date_retour_prevue,
        :nombre_passagers, :id_vehicule, 'en_attente', :objet_demande, :zone_vehicule_id
    )";
