            ...
            <div class="card shadow">
                <div class="card-header bg-danger text-white">
                    <h3 class="card-title mb-0">
                        <i class="fas fa-user-shield me-2"></i>Inscription Administrateur/Gestionnaire
                    </h3>
                </div>
                <div class="card-body">
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle me-2"></i>
                        Cette page est réservée à l'inscription des administrateurs et gestionnaires.
                    ...
                    <form id="registerAdminForm" action="../controllers/auth_controller.php?action=register"
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12">
                                <label for="role" class="form-label">
                                    <i class="fas fa-user-cog me-2"></i>Rôle
                                </label>
                                <select class="form-select" id="role" name="role" required>
                                    <option value="">Sélectionnez un rôle</option>
                                    <option value="administrateur" <?= isset($form_data['role']) && $form_data['role'] === 'administrateur' ? 'selected' : '' ?>>
                                        Administrateur
                                    </option>
                                    <option value="gestionnaire" <?= isset($form_data['role']) && $form_data['role'] === 'gestionnaire' ? 'selected' : '' ?>>
                                        Gestionnaire
                                    </option>
                                </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nom" name="nom"
                                    ...
                                    pattern="[A-Za-z\s-]+" placeholder="Entrez votre nom">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                ...
                                <!-- Pour le champ prénom -->
                                <input type="text" class="form-control" id="prenom" name="prenom"
                                    value="<?= htmlspecialchars($form_data['prenom'] ?? '') ?>" required
                                    pattern="[A-Za-z\s-]+" placeholder="Entrez votre prénom">
                                <div class="invalid-feedback">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="telephone" class="form-label">
                                    <i class="fas fa-phone me-2"></i>Téléphone professionnel
                                </label>
                                <input type="tel" class="form-control" id="telephone" name="telephone"
                                    value="<?= htmlspecialchars($form_data['telephone'] ?? '') ?>" required
                                    pattern="[0-9\s+]+" placeholder="Ex: 07 12 34 56 78">
                                <div class="invalid-feedback">
                        ...
                        <div class="row mb-3">
                            ...
                            <!-- Remplacer la section de confirmation de mot de passe -->
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="code_admin" class="form-label">
                                    <i class="fas fa-key me-2"></i>Code de sécurité administrateur
                                </label>
                                <div class="input-group">
                                    <input type="password" class="form-control" id="code_admin" name="code_admin"
                                        required placeholder="Entrez le code de sécurité">
                                    <button class="btn btn-outline-secondary" type="button" id="toggleCodeAdmin">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                </div>
                                <div class="form-text">
                                    Ce code vous a été fourni par l'administrateur système.
                                </div>
                                <div class="invalid-feedback">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-danger">
                                <i class="fas fa-user-shield me-2"></i>Créer le compte administrateur
                            </button>
                            <div class="text-center mt-3">
                                ...
                                <a href="register.php" class="btn btn-outline-primary ms-2">
                                    <i class="fas fa-user me-2"></i>Inscription utilisateur standard
                                </a>
                            </div>
                        </div>
                    </form>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="termsModalLabel">Conditions d'utilisation - Compte Administrateur</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <h6>1. Responsabilités administratives</h6>
                <p>En tant qu'administrateur, vous aurez accès à des fonctionnalités sensibles...</p>

                <h6>2. Sécurité et confidentialité</h6>
                <p>Vous vous engagez à maintenir la confidentialité des données...</p>

                <h6>3. Politique de gestion</h6>
                <p>Vous devez suivre les procédures établies pour la gestion des utilisateurs...</p>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        togglePasswordVisibility('code_admin', 'toggleCodeAdmin');
        ...
        if (roleSelect) {
            roleSelect.addEventListener('change', function () {
                if (!this.value) {
                    this.setCustomValidity("Veuillez sélectionner un rôle.");
                } else {
                    this.setCustomValidity("");
                }
            });
